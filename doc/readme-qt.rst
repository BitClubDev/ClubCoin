...
Note that brew package versions have been hardcoded in the .pro file, so the project will not build properly with
other versions of the packages / libraries. Edit them as needed.
